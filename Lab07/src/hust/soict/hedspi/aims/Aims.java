package Lab07.src.hust.soict.hedspi.aims;

import java.util.Scanner;

import Lab07.src.hust.soict.hedspi.aims.disc.CompactDisc;
import Lab07.src.hust.soict.hedspi.aims.order.Order;
import Lab07.src.hust.soict.hedspi.media.Media;
import Lab07.src.hust.soict.hedspi.test.disc.TestPassingParameter;
import Lab07.src.hust.soict.hedspi.media.Book;

// Nhớ chọn 1 khi menu lần đầu show ra để khởi tạo anOrder
	...
	public static void main(String[] args) {
		...
		while(choice < 6) {
			...
			default:
				...
				break; // Em ko hiểu sao sau khi xong case 2 của choice nó cứ in cái default này ạ
				}
		}
	}
