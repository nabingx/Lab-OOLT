package Lab07.src.hust.soict.hedspi.aims.utils;
...
public class MyDate {
	...
	private int year;
	private String stringYear; // year dáº¡ng String
	...
	// YĂªu cáº§u ng dĂ¹ng nháº­p vĂ o nhÆ° Ä‘á»‹nh dáº¡ng 3 arr trĂªn
	...
	MyDate(){
		...
		// NĂ¡ÂºÂ¿u set year lÄ‚Â  int thÄ‚Â¬ dÄ‚Â¹ng Integer.toString(year) vĂ¡ÂºÂ«n bĂ¡Â»â€¹ lĂ¡Â»â€”i
	...
	public String getMyDate2() {
		return day + " " + month + " " + year; // dĂ¹ng cho dateUtils, do cĂ¡c hĂ m tráº£ vá»� toĂ n kiá»ƒu void
	}
	...
	int StringDayToInt(String day) {
		day.toLowerCase(); // Ä‘Æ°a vá»� giá»‘ng format cá»§a days_arr 
	...
	String IntDayTH(int day) { // dĂ¹ng ná»‘i tiáº¿p method StringDayToInt
	...
	int StringMonthToInt(String month) { // check cĂ¡ch nháº­p month Ä‘Ăºng format ko
		month.toLowerCase();
