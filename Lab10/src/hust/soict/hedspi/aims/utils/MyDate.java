package Lab10.src.hust.soict.hedspi.aims.utils;
...
public class MyDate {
	...
	private int year;
	private String stringYear; // year dĂ„â€�Ă‚Â¡Ä‚â€�Ă‚ÂºÄ‚â€�Ă‚Â¡ng String
	...
	// YÄ‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Âªu cĂ„â€�Ă‚Â¡Ä‚â€�Ă‚ÂºÄ‚â€�Ă‚Â§u ng dÄ‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â¹ng nhĂ„â€�Ă‚Â¡Ä‚â€�Ă‚ÂºÄ‚â€�Ă‚Â­p vÄ‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â o nhĂ„â€�Ă¢â‚¬Â Ä‚â€�Ă‚Â° Ă„â€�Ă¢â‚¬ï¿½Ä‚Â¢Ă¢â€�Â¬Ă‹Å“Ă„â€�Ă‚Â¡Ä‚â€�Ă‚Â»Ä‚Â¢Ă¢â€�Â¬Ă‚Â¹nh dĂ„â€�Ă‚Â¡Ä‚â€�Ă‚ÂºÄ‚â€�Ă‚Â¡ng 3 arr trÄ‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Âªn
	...
	MyDate(){
		...
		// NÄ‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â¡Ă„â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚ÂºĂ„â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â¿u set year lĂ„â€�Ă¢â‚¬ï¿½Ä‚Â¢Ă¢â€�Â¬Ă¯Â¿Â½Ă„â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â  int thĂ„â€�Ă¢â‚¬ï¿½Ä‚Â¢Ă¢â€�Â¬Ă¯Â¿Â½Ă„â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â¬ dĂ„â€�Ă¢â‚¬ï¿½Ä‚Â¢Ă¢â€�Â¬Ă¯Â¿Â½Ă„â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â¹ng Integer.toString(year) vÄ‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â¡Ă„â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚ÂºĂ„â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â«n bÄ‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â¡Ă„â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â»Ă„â€�Ă‚Â¢Ä‚Â¢Ă¢â‚¬ï¿½Ă‚Â¬Ä‚â€�Ă‚Â¹ lÄ‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â¡Ă„â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â»Ă„â€�Ă‚Â¢Ä‚Â¢Ă¢â‚¬ï¿½Ă‚Â¬Ä‚Â¢Ă¢â€�Â¬Ă¯Â¿Â½i
	...
	public String getMyDate2() {
		return day + " " + month + " " + year; // dÄ‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â¹ng cho dateUtils, do cÄ‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â¡c hÄ‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â m trĂ„â€�Ă‚Â¡Ä‚â€�Ă‚ÂºÄ‚â€�Ă‚Â£ vĂ„â€�Ă‚Â¡Ä‚â€�Ă‚Â»Ä‚Â¯Ă‚Â¿Ă‚Â½ toÄ‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â n kiĂ„â€�Ă‚Â¡Ä‚â€�Ă‚Â»Ä‚â€ Ă¢â‚¬â„¢u void
	}
	...
	int StringDayToInt(String day) {
		day.toLowerCase(); // Ă„â€�Ă¢â‚¬ï¿½Ä‚Â¢Ă¢â€�Â¬Ă‹Å“Ă„â€�Ă¢â‚¬Â Ä‚â€�Ă‚Â°a vĂ„â€�Ă‚Â¡Ä‚â€�Ă‚Â»Ä‚Â¯Ă‚Â¿Ă‚Â½ giĂ„â€�Ă‚Â¡Ä‚â€�Ă‚Â»Ä‚Â¢Ă¢â€�Â¬Ă‹Å“ng format cĂ„â€�Ă‚Â¡Ä‚â€�Ă‚Â»Ä‚â€�Ă‚Â§a days_arr 
	...
	String IntDayTH(int day) { // dÄ‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â¹ng nĂ„â€�Ă‚Â¡Ä‚â€�Ă‚Â»Ä‚Â¢Ă¢â€�Â¬Ă‹Å“i tiĂ„â€�Ă‚Â¡Ä‚â€�Ă‚ÂºÄ‚â€�Ă‚Â¿p method StringDayToInt
	...
	int StringMonthToInt(String month) { // check cÄ‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Â¡ch nhĂ„â€�Ă‚Â¡Ä‚â€�Ă‚ÂºÄ‚â€�Ă‚Â­p month Ă„â€�Ă¢â‚¬ï¿½Ä‚Â¢Ă¢â€�Â¬Ă‹Å“Ä‚â€�Ă¢â‚¬ï¿½Ä‚â€�Ă‚Âºng format ko
		month.toLowerCase();
