...
public class MyDate {
	...
	private int year;
	private String stringYear; // year dĂ¡ÂºÂ¡ng String
	...
	// YÄ‚Âªu cĂ¡ÂºÂ§u ng dÄ‚Â¹ng nhĂ¡ÂºÂ­p vÄ‚Â o nhĂ†Â° Ă„â€˜Ă¡Â»â€¹nh dĂ¡ÂºÂ¡ng 3 arr trÄ‚Âªn
	...
	MyDate(){
		...
		// NÄ‚Â¡Ă‚ÂºĂ‚Â¿u set year lĂ„â€�Ă‚Â  int thĂ„â€�Ă‚Â¬ dĂ„â€�Ă‚Â¹ng Integer.toString(year) vÄ‚Â¡Ă‚ÂºĂ‚Â«n bÄ‚Â¡Ă‚Â»Ă¢â‚¬Â¹ lÄ‚Â¡Ă‚Â»Ă¢â‚¬â€�i
	...
	public String getMyDate2() {
		return day + " " + month + " " + year; // dÄ‚Â¹ng cho dateUtils, do cÄ‚Â¡c hÄ‚Â m trĂ¡ÂºÂ£ vĂ¡Â»ï¿½ toÄ‚Â n kiĂ¡Â»Æ’u void
	}
	...
	int StringDayToInt(String day) {
		day.toLowerCase(); // Ă„â€˜Ă†Â°a vĂ¡Â»ï¿½ giĂ¡Â»â€˜ng format cĂ¡Â»Â§a days_arr 
	...
	String IntDayTH(int day) { // dÄ‚Â¹ng nĂ¡Â»â€˜i tiĂ¡ÂºÂ¿p method StringDayToInt
	...
	int StringMonthToInt(String month) { // check cÄ‚Â¡ch nhĂ¡ÂºÂ­p month Ă„â€˜Ä‚Âºng format ko
		month.toLowerCase();
